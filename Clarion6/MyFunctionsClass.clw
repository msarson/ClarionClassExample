	...
	****
    ...
    MAP
        ...
        MODULE('kernel32.dll') 
            ...
            jdkCopyFileExA(*CSTRING lpExistingFileName,*CSTRING lpNewFileName,ULONG lpProgressRoutine,Long lpData,BOOL pbCancel,ULONG dwCopyFlags),BOOL,PASCAL,RAW,name('CopyFileExA')
        END
    END
